...
const Hostel = () => {
  ...
  return (
    <div className={hidden === false ? " overflow-hidden w-full h-full" : " relative  w-full h-full m-auto"}>
      ...
      <div className="w-full flex justify-between bg-white pt-3 pb-[.6rem] text-black sticky bottom-0 ">
        <Link
          href="/Packs"
